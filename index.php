...
<head>
	...
	<title>The Taproom | Flying Lion Brewing</title>
...
<body class="taproom">
	<header class="row" id="header">
        <div class="row">
            <div class="column">
            	                <a href="home.html"><img src="img/flyinglionbrewing2.svg" alt="Flying Lion Brewing" id="logo"></a>
	...
	<div class="row">
		<div class="column">
            ...
            <div class="col col-2 pad-20">
            	<img src="https://flyinglionbrewing.com/img/flying-lion-shopfront.jpg" alt="Flying Lion Brewing - Columbia City, Seattle" class="res-image featured-beer" />
            </div>
		</div>
	</div>
	<div class="row">
